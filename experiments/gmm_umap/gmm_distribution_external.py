...
from src.dataset import load_benchmark_dataset, Species, Modification, load_dataset
from src.features.encodings import multiple, binary, ncp, pstnpss, pse_knc

external_dataset = load_dataset(Species.human, Modification.psi, subsample=True, seq_len=21)
...
external_samples = encoder.fit_transform(external_dataset.samples, y=external_dataset.targets)
external_samples = umap_transformer.fit_transform(external_samples, y=external_dataset.targets)

# Transform datasets
train_samples = encoder.transform(train_dataset.samples)
train_samples = umap_transformer.transform(train_samples,)
#
